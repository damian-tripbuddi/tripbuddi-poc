...
// import { Image, Circle, Rect, Path, Animation, DragAndDrop } from 'react-konva';
      ...
      <div>
        {this.state.showLoader ? (
          <div style={borderStyle}>
            <input onChange={(e) => this.onFileLoad(e)} name={this.loaderId} type='file' id={this.loaderId} style={inputStyle} accept={this.mimeTypes} />
